...
export async function runCrunchyWithLocalCsv(inputRelativePath: string, segment: RaiseSegment) {
...
export async function runLendbaeWithLocalCsv(inputRelativePath: string) {
